...
import com.smi.reference.domain.JobHistory;
import com.smi.reference.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.smi.reference.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
